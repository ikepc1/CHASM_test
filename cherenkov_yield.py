...
class CherenkovYield(gc):
    ...
    def __init__(self,X_array,Nch_array,X0,theta,direction,tel_vectors,min_l,max_l,split):
        super().__init__(X_array,Nch_array,X0,theta,direction,tel_vectors,split)
